      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 pb-16 md:grid-cols-3">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/profissionais" className="text-muted transition hover:text-primary">Para Médicos</Link></li>
            <li><Link to="/clinicas" className="text-muted transition hover:text-primary">Para Clínicas</Link></li>
